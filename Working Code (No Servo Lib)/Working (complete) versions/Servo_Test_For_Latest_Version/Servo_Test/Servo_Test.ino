...
int pwm2;
int deg=15; // The angular positions that we want servo to go to
int reverse_deg; //
...
void setup() {
    ...
    pwm1 = map(deg, 0, 280, 116, 267);
    pwm2 = map(reverse_deg, 0, 280, 116, 267);
...
void reset_procedure(){
    while (deg>15){
        pwm1 = map(deg, 0, 280, 114, 267);
        pwm2 = map(reverse_deg, 0, 280, 114, 267);
